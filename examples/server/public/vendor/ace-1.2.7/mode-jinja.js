...
define("ace/mode/jinja",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/html_highlight_rules","ace/mode/text_highlight_rules"], function(require, exports, module) {
...
var JinjaHtmlHighlightRules = function() {
    ...
    for (var i in this.$rules) {
        ...
        this.embedRules(JinjaHighlightRules, "jinja-", [{
                token: "comment.block",
...
oop.inherits(JinjaHtmlHighlightRules, HtmlHighlightRules);

var Mode = function() {
    HtmlMode.call(this);
    this.HighlightRules = JinjaHtmlHighlightRules;
};
oop.inherits(Mode, HtmlMode);

(function() {
    this.$id = "ace/mode/html/jinja";
}).call(Mode.prototype);
